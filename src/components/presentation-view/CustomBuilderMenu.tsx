...
const CustomBuilderMenu: React.FC<ClickProps> = ({
  ...
  return (
    <div className="flex flex-col h-full lg:px-4 lg:py-3">
      ...
      {/* Desktop View */}
      <div className="hidden lg:grid grid-cols-3 md:grid-cols-4 gap-2 sm:gap-4 mt-3 md:mt-6 lg:mt-12">
        {slideTypes.map((type) => (
          <div
            key={type.name}
            className="flex flex-col items-center border border-[#E1E3E5] rounded-lg flex-shrink-0 cursor-pointer shadow-md hover:shadow-lg transition-shadow"

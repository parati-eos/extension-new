    ...
    <div className="bg-gradient-to-r from-[#EAF2FF00] to-[#99C1FF1F] min-h-screen text-center">
      ...
      <div className="relative flex flex-col items-center justify-start pt-32 mb-20">
        <h1 className="text-4xl font-bold text-gray-900 z-10">
          Effortlessly <span className="text-[#3667B2]">Turn Ideas</span> into Slides with Your
        </h1>
        <h1 className="mt-2 text-4xl font-bold text-[#3667B2] z-10">
          AI Presentation Generator
        </h1>
        <p className="mt-4 text-gray-700 max-w-lg z-10">
          From startup pitch decks to corporate proposals, Zynth’s AI presentation maker helps you
          craft visually compelling, professional-grade slides in minutes—no design skills required.
        </p>
      ...
      <div className="relative  z-20  ">
        ...
        <div
          ...
          style={{
            height: 'calc(100% + 20%)',
            background: 'linear-gradient(to bottom, #EAF2FF00 0%, #99C1FF1F 12%, rgba(0,0,0,0))',
            zIndex: -1,
          }}
        />

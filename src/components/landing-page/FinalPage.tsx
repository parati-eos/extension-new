    ...
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
      <div className="text-center md:text-left mb-6 md:mb-0">
        ...
        <p className="text-gray-700 text-sm">
          Create your investor presentations in a few minutes using our AI-powered pitch deck builder.
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left">
      <div>
        ...
        <ul className="space-y-2">
          ...
          <li><a href="#" className="text-gray-600 hover:underline">Impact DB</a></li>
          <li><a href="#" className="text-gray-600 hover:underline">Parati Eos</a></li>
        </ul>
      </div>
      <div>
        <h3 className="font-bold text-gray-800 mb-4">Services</h3>
        <ul className="space-y-2">
          <li><a href="#" className="text-gray-600 hover:underline">Business Strategy</a></li>
          <li><a href="#" className="text-gray-600 hover:underline">Investor Relations</a></li>
          <li><a href="#" className="text-gray-600 hover:underline">Managed Operations</a></li>
          <li><a href="#" className="text-gray-600 hover:underline">Digital Transformation</a></li>
        </ul>
      </div>
      <div>
      ...
      <div>
        ...
        <ul className="space-y-2">
          ...
          <li><a href="#" className="text-gray-600 hover:underline">Refunds and Cancellations</a></li>

...
import UseCasesPitch from '../components/landing-page/UseCasesPitch';
import UseCasesMarketing from '../components/landing-page/UseCasesMarketing';
import UseCasesEmployee from '../components/landing-page/UseCasesEmployee';
import UseCasesBoard from '../components/landing-page/UseCasesBoard';
import UseCasesEducation from '../components/landing-page/UseCasesEducation';

const UseCasesEducationPage: React.FC = () => {
  return (
...
export default UseCasesEducationPage;
